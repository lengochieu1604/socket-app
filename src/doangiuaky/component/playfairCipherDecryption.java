...
public class playfairCipherDecryption
{
    ...
    public static String viTriChuoiCon(String s1, String s2) { 
        String s11 = s1;
        String temp = "";
        int n1 = s1.length();
        int n2 = s2.length();
        ...
        for (int i = 0; i < s11.length(); i++) {
            if (s11.contains(s2)) {
                int vt = s11.indexOf(s2);
                int n11 = s11.length();
                s11 = s11.substring(0, vt) + s11.substring(vt + n2, n11);
                int out = vt + k * n2;
                System.out.println(out + " | " + s11);
                k++;
    ...
    public String xoaTrang(String s1){
